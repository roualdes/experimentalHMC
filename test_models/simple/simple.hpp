...
static constexpr std::array<const char*, 5> locations_array__ =
  ...
  " (in 'test_models/simple/simple.stan', line 6, column 2 to column 14)",
  " (in 'test_models/simple/simple.stan', line 9, column 2 to column 28)",
  " (in 'test_models/simple/simple.stan', line 3, column 2 to column 17)",
  " (in 'test_models/simple/simple.stan', line 6, column 9 to column 10)"};
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      y = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(N);
      {
        ...
        lp_accum__.add((-0.5 *
          stan::math::multiply(stan::math::transpose(y), y)));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
