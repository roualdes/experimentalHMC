...
namespace jacobian_model_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 3> locations_array__ =
  {" (found before start of program)",
  " (in 'test_models/jacobian/jacobian.stan', line 2, column 2 to column 18)",
  " (in 'test_models/jacobian/jacobian.stan', line 5, column 2 to column 19)"};
class jacobian_model final : public model_base_crtp<jacobian_model> {
 private:
  
 public:
  ~jacobian_model() {}
  jacobian_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "jacobian_model_namespace::jacobian_model";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "jacobian_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "jacobian_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = jacobian_model_namespace::jacobian_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return jacobian_model_namespace::profiles__;
}
#endif