...
namespace matrix_model_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 4> locations_array__ =
  {" (found before start of program)",
  " (in 'test_models/matrix/matrix.stan', line 2, column 2 to column 17)",
  " (in 'test_models/matrix/matrix.stan', line 5, column 2 to column 21)",
  " (in 'test_models/matrix/matrix.stan', line 8, column 2 to column 8)"};
class matrix_model final : public model_base_crtp<matrix_model> {
 private:
  
 public:
  ~matrix_model() {}
  matrix_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "matrix_model_namespace::matrix_model";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "matrix_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      A = in__.template read<Eigen::Matrix<local_scalar_t__,-1,-1>>(3, 2);
      std::vector<std::vector<local_scalar_t__>> B =
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "matrix_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"A\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(3) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(3) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(2) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = matrix_model_namespace::matrix_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return matrix_model_namespace::profiles__;
}
#endif